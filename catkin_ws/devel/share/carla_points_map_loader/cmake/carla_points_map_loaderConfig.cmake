...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'carla_points_map_loader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lukas/carla/carla-autoware/catkin_ws/src/carla_points_map_loader/${idir}'.  ${_report}")
    endif()
